"""Stage and replay the local review bundle in an isolated code checkout.
...
def replay():
    ...
    import pandas as pd
    table_checks = {}
    for name in ('f2_pareto_frontier_source.csv', 'f3_lca_balance_components.csv',
    ...
    report = {'scope': 'Replay from frozen scenario intermediates; PV dispatch is recalculated from processed time series',
